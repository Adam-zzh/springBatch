 ...
 * 渠道拒收订单的佣金明细
 */
@Component("refuseCommissionDetailProcessor")
public class RefuseCommissionDetailProcessor implements ItemProcessor<GshopOrderModel, GfmChannelCommissionDetail> {
	...
	public GfmChannelCommissionDetail process(GshopOrderModel gshopOrderModel) throws Exception {
		...
		//订单类型
		channelCommissionDetail.setOrderType(3);
		//订单时间
