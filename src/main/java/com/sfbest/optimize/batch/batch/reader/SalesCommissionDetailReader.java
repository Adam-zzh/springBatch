...
@Component
@StepScope
public class SalesCommissionDetailReader extends MyBatisPagingItemReader<GshopOrderModel>{

        Logger logger= LoggerFactory.getLogger(SalesCommissionDetailReader.class);

        @Value("com.sfbest.optimize.batch.mapper.db2.GshopOrderMapper.queryChannelSalesOrder")
        @Override
