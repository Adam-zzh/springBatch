 ...
 * 渠道销售订单的佣金明细
 */
@Component("salesCommissionDetailProcessor")
public class SalesCommissionDetailProcessor implements ItemProcessor<GshopOrderModel, GfmChannelCommissionDetail> {
	...
	public GfmChannelCommissionDetail process(GshopOrderModel gshopOrderModel) throws Exception {
		...
		//订单类型
		channelCommissionDetail.setOrderType(1);
		//订单时间
