...
@Component
@StepScope
public class ReturnCommissionDetailReader extends MyBatisPagingItemReader<GshopOrderModel>{

        Logger logger= LoggerFactory.getLogger(ReturnCommissionDetailReader.class);

        @Value("com.sfbest.optimize.batch.mapper.db2.GshopOrderMapper.queryChannelReturnOrder")
        @Override
